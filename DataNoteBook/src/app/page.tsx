...
//         // Fallback: extract basic info if it's a CSV
...
//             // triggerBanner("Backend analysis unavailable, using local estimation", "err");
//           } catch (e) {
//             console.error("Local fallback extraction failed", e);
//           }
//         } else {
//           // triggerBanner(analyzeResult.error || "Analysis failed.", "err");
//           // alert("Analysis failed: " + (analyzeResult.error || "unknown error"));
//           // return;
//         }
//       }
...
//       setMessages((prev) => [
//         ...prev,
//         { role: "ai", text: data?.explanation || "Here is the code.", code: data?.code || null },
//       ]);
...
//   }, [cells, notebookId, notebookTitle, session]);
...
//             onCloseGeminiTab={closeGeminiTab}
//             onClosePreviewTab={closePreviewTab}
//             onRefreshResources={loadProjectResources}
//           />
//         )}
...
function WorkspaceContent() {
  ...
  // Reset folder-prompt guard when project changes
  React.useEffect(() => {
    hasPromptedFolderRef.current = false;
  }, [createdProjectId]);
